...
@Component
public class WeeklyEventSubscriptionsLoader implements Tasklet, StepExecutionListener {
    private static final Logger logger = LoggerFactory.getLogger(WeeklyEventSubscriptionsLoader.class);
    ...
    public ExitStatus afterStep(StepExecution stepExecution) {
        this.index = 0;
        logger.debug("WeeklyEventSubscriptionsLoader finished.");
