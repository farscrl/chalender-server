...
public class EventFixtures {
    ...
    public List<Event> getEvents() {
        ...
        ev1.setOccurrences(eventOccurrences(false, generateDate(0), "17:30", "19:30", false));
        ...
        ev2.setOccurrences(eventOccurrences(true, generateDate(0), null, null, false));
        ev2.setRegions(getRegions("15"));
        ...
        ev3.setOccurrences(eventOccurrences(false, generateDate(0), "12:15", "13:15", false));
        ev3.setRegions(getRegions("4"));
        ...
        ev4.setOccurrences(eventOccurrences(false, generateDate(1), "08:00", "15:00", false));
        ...
        ev4Old.setOccurrences(eventOccurrences(false, generateDate(2), "08:00", "16:00", false));
        ...
        ev5.setOccurrences(eventOccurrences(false, generateDate(2), "17:30", "20:00", false));
        ev5.setRegions(getRegions("8,9,10,11"));
        ...
        ev6.setOccurrences(eventOccurrences(false, generateDate(2), "18:15", "19:30", false));
        ev6.setRegions(getRegions("2"));
        ...
        ev7.setOccurrences(eventOccurrences(false, generateDate(2), "08:00", "15:00", false));
        ev7.setRegions(getRegions("4"));
        ...
        ev8.setOccurrences(eventOccurrences(false, generateDate(2), "18:00", "20:00", false));
        ...
        ev9.setOccurrences(eventOccurrences(false, generateDate(2), "16:30", "18:00", false));
        ...
        ev10.setOccurrences(eventOccurrences(true, generateDate(2), null, null, false));
        ev10.setRegions(getRegions("4"));
        ...
        ev11.setOccurrences(eventOccurrences(false, generateDate(3), "16:30", "18:00", false));
        ev11.setRegions(getRegions("4"));
        ...
        ev12.setOccurrences(eventOccurrences(false, generateDate(3), "16:30", "18:00", false));
        ...
        ev13.setOccurrences(eventOccurrences(false, generateDate(3), "16:30", "18:00", false));
        ev13.setRegions(getRegions("2"));
        ...
        ev14.setOccurrences(eventOccurrences(false, generateDate(3), "16:30", "18:00", false));
        ev14.setRegions(getRegions("8"));
        ...
        ev15.setOccurrences(eventOccurrences(false, generateDate(3), "08:00", "18:00", false));
        ev15.setRegions(getRegions("8"));
        ...
        ev16.setOccurrences(eventOccurrences(false, generateDate(4), "08:00", "18:00", false));
        ev16.setRegions(getRegions("4"));
